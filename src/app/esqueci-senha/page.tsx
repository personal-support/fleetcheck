    ...
    <main style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: 'var(--cd-bg)' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '32px 20px' }}>
        <div className="cd-card animate-fade-up" style={{ width: '100%', maxWidth: 400, padding: '28px 24px' }}>
          {!sent ? (
            <>
              <h2 style={{ fontFamily: "'Barlow Condensed', sans-serif", fontSize: 22, fontWeight: 800, color: 'var(--cd-navy)', marginBottom: 6 }}>RECUPERAR ACESSO</h2>
              <p style={{ fontSize: 14, color: 'var(--cd-subtext)', marginBottom: 20, lineHeight: 1.5 }}>Informe seu e-mail corporativo. Enviaremos um link para você recuperar o acesso.</p>
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                <div>
                  <label className="cd-label">E-mail</label>
                  <input className="cd-input" type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="seu.nome@fleetcheck.com.br" required />
                </div>
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ fontSize: 13, color: 'var(--cd-subtext)', lineHeight: 1.6 }}>Verifique <strong>{email}</strong> e clique no link para recuperar o acesso.</p>
