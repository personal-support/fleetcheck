...
const PUBLIC_ROUTES = ['/login', '/login-cpf', '/cadastro', '/esqueci-senha', '/recuperar-senha', '/selecionar-perfil', '/definir-senha', '/auth/callback', '/admin/solicitar-acesso', '/check/veiculo']
